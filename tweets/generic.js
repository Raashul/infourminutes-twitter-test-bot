...
module.exports.pickGeneric = (hashtag, url, screen_name) => {
  ...
  if(randomGeneric == 1){
    let tweet = {
      status: '@' + screen_name + ' ' + hashtag + '  impressed us immensely. Hence, we wrote a summary of the whitepaper here: '
      + url + '. Feel free to follow @infourminutesco to get a summary of a whitepaper every week.'
    }
    return tweet;
  }
    ...
    let tweet = {
      ...
      ' whitepaper. Feel free to check this link out: ' + url + ' and follow us at @infourminutesco.'
    }
    return tweet;
  }
